...
def _worker_instructions(task: Task) -> list[str]:
    instructions = [
        ...
        "If resume_from_kernel_memory is available and task.metadata.kernel_memory exists, call it before repeating work.",
        ...
        "For VERIFY/verify_only, kernel_memory is context only; passing verification requires command evidence or verify_file_state_against_manifest evidence.",
