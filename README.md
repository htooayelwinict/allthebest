...
[![Tests](https://img.shields.io/badge/Tests-678%20passing-1f2937?style=for-the-badge&logo=pytest&logoColor=f59e0b)](https://docs.pytest.org/)
...
| **Offline Test Suite** | 678 pytest cases run against the faux provider without network calls. |
...
│   └── tests/                  # Current appV2.3 suite (678 pytest cases)
